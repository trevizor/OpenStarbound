...
Json const AdditionalDefaultConfiguration = Json::parseJson(R"JSON(
    {
      ...
      "bindings" : {
        ...
        "InterfacePlaceTorchAtCursor" : [ { "type" : "key", "value" : "G", "mods" : [] }, { "type" : "controller", "value" : "DPadUp" } ],
        "InterfaceUseFirstHealingItem" : [ { "type" : "key", "value" : "H", "mods" : [] }, { "type" : "controller", "value" : "DPadDown" } ],
